...
## Key Takeaways:
  ...
  - Networking provides far more (and more reliable) information than can be obtained in an interview, and is usually associated with a personal referral by an existing team member. Networking also serves as **technical interview practice,** because you will learn software developer jargon (professional terminology) comfortably. (Podcasts and blogs are also great for learning the jargon, as well as the relationships between different technologies or approaches.)
